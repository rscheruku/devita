...
(function($) {
	...
	jQuery(document).ready( function(){
		...
		if(jQuery('#mega_main_menu ul.mega_main_menu_ul > li.menu-item').length < devita_menu_number ){
			jQuery('.morelesscate').css('display', 'none');
			jQuery('.morelesscate').addClass('alwayshide');
		}
		
		//init height
		oldCateMenuH = devita_menu_number * jQuery('#mega_main_menu ul.mega_main_menu_ul > li.menu-item').outerHeight() + jQuery('.catemenu-toggler').outerHeight();
