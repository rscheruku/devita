...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header Digital 4' || $jscomposer_template->post_title == 'Footer Digital 3'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper <?php if($devita_opt['page_layout']=='box'){echo 'box-layout';}?>">
		<div class="page-wrapper">
			<div class="header-container header-digital-4">  
			 	<div class="header"> 
					<div class="header-content">
						...
						if ( isset($devita_opt['header_layout']) && $devita_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header Digital 4'){
