...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header Book 2' || $jscomposer_template->post_title == 'Footer Book 2'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper <?php if($devita_opt['page_layout']=='box'){echo 'box-layout';}?>">
		<div class="page-wrapper">
			<div class="header-container header-book-2">  
			 	<div class="header"> 
					<div class="header-content">
						...
						if ( isset($devita_opt['header_layout']) && $devita_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header Book 2'){
			...
			<div class="footer footer-book-2">
				<?php
				if ( isset($devita_opt['footer_layout']) && $devita_opt['footer_layout']!="" ) {
					...
					if(count($jscomposer_templates) > 0) {
						foreach($jscomposer_templates as $jscomposer_template){
							if($jscomposer_template->post_title == 'Footer Book 2'){
								echo do_shortcode($jscomposer_template->post_content);
							}
						}
					}
