...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Header Digital 2' || $jscomposer_template->post_title == 'Footer Digital 2'){
		...
		<div class="page-wrapper">
			 	...
			 	<div class="header"> 
					<div class="header-content">
						...
						if ( isset($devita_opt['header_layout']) && $devita_opt['header_layout']!="") {
							...
							if(count($jscomposer_templates) > 0) {
								foreach($jscomposer_templates as $jscomposer_template){
									if($jscomposer_template->post_title == 'Header Digital 2'){
			...
			<div class="footer footer-digital-2">
				...
				if ( isset($devita_opt['footer_layout']) && $devita_opt['footer_layout']!="" ) {
					...
					if(count($jscomposer_templates) > 0) {
						foreach($jscomposer_templates as $jscomposer_template){
							if($jscomposer_template->post_title == 'Footer Digital 2'){
								echo do_shortcode($jscomposer_template->post_content);
							}
						}
					}
