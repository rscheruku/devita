		...
		<div class="post-info"> 
			...
			<?php else : ?>
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($devita_opt['readmore_text']) && $devita_opt['readmore_text']!=''){ echo esc_html($devita_opt['readmore_text']); } else { echo esc_html_e('Read more', 'devita');}  ?></a>
